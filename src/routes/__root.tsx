  ...
  head: () => ({
    meta: [
      ...
      { title: "Premium Woollen Wear, Made for Winter | YOUR BRAND" },
      {
        name: "description",
        content:
          "Shawls, sweaters, caps, scarves, gloves and socks made in our own woollen unit. Free shipping above ₹999.",
      },
      { property: "og:title", content: "Premium Woollen Wear, Made for Winter | YOUR BRAND" },
      {
        property: "og:description",
        content: "Woollen clothing made in our own unit and delivered across India.",
      },
